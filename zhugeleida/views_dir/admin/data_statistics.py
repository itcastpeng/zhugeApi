            ...
            if oper_type == 'article_data_analysis':
                ...
                for obj in objs:
                    ...
                    ret_data.append({
                        ...
                        'forward_count': forwarding_article_data.get('forwarding_article_count'),       # 文章转发数量
                        'forward_data': forwarding_article_data.get('data_list'),                       # 文章转发数据

                        'click_count': click_quantity_data.get('click_count'),                          # 文章点击数量
            ...
            # 员工数据分析
                ...
                for obj in objs:
                    ...
                    ret_data.append({
                        ...
                        'average_response_count': average_response_data.get('average_response'),            # 平均响应时长
