            ...
            if MsgType == 'event':  # 事件处理
                ...
                if gongzhonghao_app_objs:
                    ...
                    if objs:
                        ...
                        res_msg = '<xml><ToUserName><![CDATA[{openid}]]></ToUserName><FromUserName><![CDATA[{original_id}]]></FromUserName><CreateTime>{createtime}</CreateTime><MsgType><![CDATA[text]]></MsgType><Content><![CDATA[{content}]]></Content><MsgId>6613567410772340882</MsgId></xml>'.format(
                            openid=openid, original_id=original_id, createtime=createtime, content='YYYY')
