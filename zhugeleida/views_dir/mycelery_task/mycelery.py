    ...
    if product_function_type != 3:
        ...
        if xiaochengxu_app_objs:
            ...
            if customer_id:
                ...
                create_user_or_customer_small_program_poster.delay(json.dumps(data_dict))
    ...
    if shangcheng_objs:
        ...
        if activity_single_money > account_balance and is_used_daifa_redPacket == 1:  # 当 发送金额大于账户余额
            ...
            for obj in objs:
                ...
                monitor_send_gzh_template_msg.delay(data_dict)
        ...
        if 'errcode' not in ret_json:
            ...
            if formid != '已发':
                ...
                if int(company_id) == 15:
                    msg = '终于等到您，我是您的专属客服代表{}-{}，有什么问题您可以致电或留言，我随时帮您解答！'.format(
                        company_objs[0].name, user_objs[0].username
                    )
