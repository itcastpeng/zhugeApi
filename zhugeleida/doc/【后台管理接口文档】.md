...
``` python
{
    ...
    "data":{
        "ret_data":[
            {
                "id":1,
                "belong_user": 18643129824,     # 小程序所属账户
                "company_id":1,         
                "company_name":"大麦公司11",
                ...
                "reason":"提交审 核代码报错: 85009 : already submit a version under auditing hint: [0F6H703469030]"    # 会有报错会有报错的理由。
            }
        ],
        "data_count":1
    }
...
{
    "code":85009,
    "msg":"提交审核代码报错: 85009 : already submit a version under auditing hint: [IsYega06870720]",
    "data":{
