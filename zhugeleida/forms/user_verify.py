...
class UserAddForm(forms.Form):
    ...
    #     print('-----department_id list -------->>',department_id)
    #     obj = models.zgld_userprofile.objects.filter(id=department_id)
    #     company_id = obj[0].company_id
    #
    #     if obj and company_id == self.clean_company_id():
    #         return department_id
    #
    #     else:
    #         self.add_error('department_id', '部门id不存在')
